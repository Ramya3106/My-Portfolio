...
const ExperienceTopRight = () => {
  return (
    <div className="xl:w-[25%] lg:w-[30%] border border-lightBrown px-4 rounded-xl">
      <p className="text-lg text-center text-lightGrey">
        I specialize in{" "}
        <span className="font-bold text-white">
          React, modern Javascript and Nodejs
        </span>
        ...
        <span className="font-bold text-white">
          complex front-end and back-end systems
        </span>
        , always aiming for clean code andexceptional user experience.
      </p>
    </div>
  );
};
